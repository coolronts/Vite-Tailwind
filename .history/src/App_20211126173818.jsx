      ...
      <SplitScreen leftWeight = 'w-3/5 pr-2' rightWeight="w-full bg-purple-50 rounded-2xl px-6 ml-8">
        <div id="left">
          ...
          <div id="course">
            ...
            <div className="mb-8 overflow-y-scroll overflow-x-hidden pr-5 h-96 pb-12 scrollbar scrollbar-thin scrollbar-thumb-purple-200 scrollbar-track-transparent">
              <PrimaryCard>
                <Course/>
              </PrimaryCard>
              <PrimaryCard>
