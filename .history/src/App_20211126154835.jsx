...
function App() {
  ...
  const MenuComponent = ({item})=> <p className="text-sm font-medium text-gray-500">{item}</p>
  return (
    ...
    <div className="App ">
      ...
      <SplitScreen leftWeight = 'w-2/5'>
        <div id="left">
          ...
          <div id="Class" className="pr-48">
              <p className="text-2xl font-bold font-sans mb-2">Your Class</p>
              <RowList 
                  items={classMenu}
