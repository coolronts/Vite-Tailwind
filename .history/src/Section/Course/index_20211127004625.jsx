...
export default function Course({
  ...
  return (
    <div className="">
    <SplitScreen leftWeight = 'w-3/5' rightWeight = 'flex-grow'>
      <div id="left" className="relative flex justify-center items-center ">
          <DoughnutChart />
          <DNA className="text-6xl text-red-600 z-24 absolute bg-transparent inline-block h-1/4 w-1/4 rounded-full ring-2 ring-white"/>
      </div>
      <div id="right" className="ml-4 w-full">
