...
export default function Course({
  ...
  return (
    ...
    <SplitScreen leftWeight = 'w-1/4' rightWeight = 'w-full'>
      <div id="left" className="relative flex justify-center items-center h-full w-full">
          <Chart />
          <img className="w-16 z-24 absolute opacity-100 bg-transparent"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8_8Y88DmyWPbSmg7BLxCdriq2c5jOL8dYsA&usqp=CAU"
            alt="" />
      </div>
