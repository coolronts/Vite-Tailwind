      ...
      <SplitScreen>
        <div id="left">
          <div>
            ...
            <h5 className="text-sm font-semibold tracking-wide text-gray-500">Nice to have you Back, what an exciting day!</h5>
            <h5 className="text-sm font-semibold tracking-wide text-gray-500">Get Ready and enjoy your lesson today</h5>
